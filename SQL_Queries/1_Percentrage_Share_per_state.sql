...
SELECT
    ...
    phev,
    ROUND((phev*1.0/total_vehicles),2) AS phev_percentage,
    hev,
    ROUND((hev*1.0/total_vehicles),2) AS hev_percentage,
    gasoline,
    ROUND((gasoline*1.0/total_vehicles),2) AS gas_percentage
FROM sum_calc;
